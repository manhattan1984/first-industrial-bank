  ...
  const handleSignUp = async () => {
    ...
    if (user) {
      sendEmailToUser(
        ...
        Log Into your account: <a href="https://www.first industrial bank.com/signin">Log In</a>
        `
      );
      ...
      <div className="bg-neutral-50 p-2">
        <div className="max-w-lg mx-auto p-4 shadow m-4 rounded bg-white flex flex-col gap-3">
          ...
          <div className="text-center my-2">
            <p className="text-3xl">First Industrial Bank</p>
          </div>
          ...
          <div className="flex my-4 items-center gap-2">
            <input
              ...
              id=""
            />
            <p className="text-xs">I agree to First Industrial Bank terms of use</p>
          </div>
          <div className="">
            <HCaptcha
