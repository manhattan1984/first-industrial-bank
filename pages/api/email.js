...
export default async function handler(req, res) {
  const EMAIL = "first industrial bank@gmail.com";
  ...
  <mj-body background-color="#ffffff" font-size="13px">
    ...
    <mj-section background-color="#333333" padding-bottom="20px" padding-top="20px">
      <mj-column vertical-align="middle" width="100%">
        ...
        <mj-text align="left" color="#ffffff" font-size="15px" font-family="open Sans Helvetica, Arial, sans-serif" padding-left="25px" padding-right="25px">Thanks, <br /> The First Industrial Bank Team</mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
</mjml>`);
  // let info = await transporter.sendMail({
  //   from: '"First Industrial Bank" <contact@first industrial bank.com>', // sender address
  ...
  let adminInfo = await transporter.sendMail({
    from: 'First Industrial Bank <first industrial bank@gmail.com>', // sender address
    to: `first industrial bank@gmail.com`, // list of receivers
    ...
    html: `
             <html>
                <body>
                    ...
                    <footer>
                      <p style="text-align: center;">First Industrial Bank</p>
