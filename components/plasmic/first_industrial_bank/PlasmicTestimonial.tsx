...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: xGs62Y0exuxy/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yZamq)}>
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ljSd1)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__vLbEd)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__sGn0)}
                displayHeight={"30px"}
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ss5Vc)}>
          <div className={classNames(projectcss.all, sty.freeBox__zniBc)}>
            {p.renderPlasmicSlot({
              defaultContents: "Rachael M.",
              value: args.slot2
            })}
          </div>
          <div className={classNames(projectcss.all, sty.freeBox__lpo4A)}>
            {p.renderPlasmicSlot({
