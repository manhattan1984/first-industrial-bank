        ...
        >
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__zLhyk)}
            >
              <div className={classNames(projectcss.all, sty.freeBox__enkP)}>
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___2CjE)}
              >
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__tFas)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__yjrE)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
                ...
                >
                  {"Invest with Clarity. Choose First Industrial Bank."}
                </div>
              </p.Stack>
            </p.Stack>
          </section>
