...
import sty from "./PlasmicMetricItem.module.css"; // plasmic-import: rjv3_n7cRqnT/css
...
function PlasmicMetricItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__soUlo)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <div
              className={classNames(
      ...
      <div className={classNames(projectcss.all, sty.freeBox___0Bwwa)}>
        {p.renderPlasmicSlot({
