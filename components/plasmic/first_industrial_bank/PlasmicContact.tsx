...
import sty from "./PlasmicContact.module.css"; // plasmic-import: SSd2P94Pz9tz/css
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <Icon12Icon
            className={classNames(projectcss.all, sty.svg__qdd6A)}
            role={"img"}
          />
        ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__lGjal)}>
        <div className={classNames(projectcss.all, sty.freeBox__aBaam)}>
          {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__osk1H)}>
        {p.renderPlasmicSlot({
          defaultContents: "We are here to help.",
          value: args.slot
        })}
      </div>
      <div className={classNames(projectcss.all, sty.freeBox__nKda)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicLink
              className={classNames(
