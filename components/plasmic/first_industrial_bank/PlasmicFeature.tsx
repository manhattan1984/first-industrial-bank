...
import sty from "./PlasmicFeature.module.css"; // plasmic-import: dA1kMAc3QseA/css

import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 0M6H1XRwvgTO/icon
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <Icon2Icon
            className={classNames(projectcss.all, sty.svg__yrHVo)}
            role={"img"}
          />
        ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__w7RSv)}>
        <div className={classNames(projectcss.all, sty.freeBox__c8MM6)}>
          {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ho0Ye)}>
        {p.renderPlasmicSlot({
          defaultContents:
